    ...
    <div>
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
            <h1>
              <router-link to="/" title="壮云电商">Xiaoman</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
            ...
            <div class="w">
              <ul class="nav-list">
                <li v-for="(item, i) in navType" :key="i" class="nav-type">
                  ...
                  <ul v-show="item.children && item.children.length" class="child-ul">
                    <li v-for="(item1, j) in item.children" :key="j"><router-link :to="{path: item1.link, query: { keyword: item1.query && item1.query.keyword ? item1.query.keyword: ''}}">{{item1.text}}</router-link></li>
                  </ul>
                </li>
              </ul>
            </div>
    ...
    data () {
      return {
        ...
        navType:[{  // 暂时写死
            ...
            text: '箱包',
            link: '/goods?keyword=bags',
            query: {keyword: 'bags|bag'},
            children: [{
                text: '包包',
                link: '/goods',
                query: {keyword: 'bag'}}
